...
class Crypto extends Component {
            ...
            .then(res => {
                ...
                this.setState((state) => {
                    ...
                    for (const [ticker, cryptoRate] of Object.entries(tickers)) {
                        ...
                        let lastCryptoObj = state.cryptoList.find(obj =>
                            obj.currency === ticker
                        );
    ...
    filterCryptoList = () => {
        ...
        this.setState((state) => {
            let newFilteredCryptoList = state.cryptoList.filter(obj => obj.currency
                .includes(this._inputFilter.value));
    ...
    render() {
        return (
            <div className="Crypto">
                <input ref={element => this._inputFilter = element} type="text"
                    placeholder="Filter" onChange={this.filterCryptoList} />
